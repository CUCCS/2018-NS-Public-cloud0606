...
## 三、实验步骤
### 多重加载
1. 从教学ftp下载.ova（Open Virtual Appliance）文件，导入虚拟电脑
2. 管理->虚拟介质管理->释放
3. 类型设置为【多重加载】
4. 重新给虚拟机添加虚拟硬盘
5. 新建新的虚拟机,选择现有的盘片->成功。

	![](img/multipleloading.png)
...
- [https://www.virtualbox.org/manual/ch06.html#network_nat_service](https://www.virtualbox.org/manual/ch06.html#network_nat_service "虚拟机网络配置")
- [https://unix.stackexchange.com/questions/14056/what-is-kernel-ip-forwarding](https://unix.stackexchange.com/questions/14056/what-is-kernel-ip-forwarding "理解ipforward")
- [https://kali.training/topic/firewall-or-packet-filtering/](https://kali.training/topic/firewall-or-packet-filtering/)

参考同学作业：

- [https://github.com/CUCCS/2018-NS-Public-Sismark/pull/1/commits/625035b045f531a7c02566cae6d4b6f0fc860687](https://github.com/CUCCS/2018-NS-Public-Sismark/pull/1/commits/625035b045f531a7c02566cae6d4b6f0fc860687)
